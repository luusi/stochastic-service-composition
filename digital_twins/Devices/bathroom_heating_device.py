...
from base import BoschIotDevice

"""tenant_id = "t6f04cf30b6b34842bfe43e6d9da37818_hub"
device_password = "secret"
hub_adapter_host = "mqtt.bosch-iot-hub.com"
device_id = "com.bosch.services:bathroom_heating_device"
client_id = device_id
auth_id =  "com.bosch.services_bathroom_heating_device"
certificate_path = "./iothub.crt"
...
publishTopic = "telemetry/" + tenant_id + "/" + device_id

# Output relevant information for consumers of our information
print("Connecting client:    ", client_id)
